(function (global, factory) {
  ...
  function parseCssInt(str) {
    ...
    if (str.length && str.charAt(str.length - 1) === '%') {
      return clampCssByte(_parseFloat$2(str) / 100 * 255);
    }

    return clampCssByte(_parseInt$2(str, 10));
  }

  function parseCssFloat(str) {
    // float or percentage.
    if (str.length && str.charAt(str.length - 1) === '%') {
      return clampCssFloat(_parseFloat$2(str) / 100);
    }

    return clampCssFloat(_parseFloat$2(str));
  }
  ...
  function parse(colorStr, rgbaArr) {
    ...
    if (str.charAt(0) === '#') {
      if (str.length === 4) {
        var iv = _parseInt$2(str.substr(1), 16); // TODO(deanm): Stricter parsing.
        ...
        var _iv = _parseInt$2(str.substr(1), 16); // TODO(deanm): Stricter parsing.
  ...
  function hsla2rgba(hsla, rgba) {
    var h = (_parseFloat$2(hsla[0]) % 360 + 360) % 360 / 360; // 0 .. 1
