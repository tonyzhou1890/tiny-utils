(function (global, factory) {
  ...
  function transferProperties(source, transferProperties) {
    ...
    function transfer(source, transferProperties) {
      ...
      if (isArray(source)) {
        ...
        keys$1(source).map(function (key) {
          // 检查是否需要转换
  ...
  function parseTime(time, cFormat) {
    ...
    if (_typeof_1(time) === 'object') {
      date = time;
    } else {
      if (('' + time).length === 10) time = _parseInt$2(time) * 1000;
      date = new Date(time);
    }
